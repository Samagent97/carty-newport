  ...
  return (
    <section className="py-12 px-8 lg:py-24">
      <div className="container max-w-screen-lg mx-auto">
        ...
        <CustomCard color="transparent" shadow={false} className="py-8 lg:flex-row">
          <CustomCardBody className="w-full lg:gap-10 h-full lg:!flex justify-between ">
            <div className="w-full mb-10 lg:mb-0">
              ...
              <CustomTypography className="mb-3 w-full lg:w-8/12 font-normal !text-gray-500">
              ...
              <CustomTypography variant="h6" color="blue-gray" className="mb-0.5">
